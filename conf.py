...
BLOG_AUTHOR = "Steve Harris"  # (translatable)
BLOG_TITLE = "UCL Healthcare Algorithm Laboratory"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://docsteveharris.github.io/uclhal/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "hello@steveharris.me"
BLOG_DESCRIPTION = "Test site for UCL HAL"  # (translatable)
...
# Run this ./uclhal/uclhal
DEPLOY_COMMANDS = {
    'default': [
        "ghp-import --no-jekyll --push --message='deploying output'  output",
    ]
}

# ^^^ SEE ABOVE: NOT using the default github_deploy command b/c of nested directory
# ----------------------------------------------------------------------------------
